...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.myRequest = void 0; //const BASR_URL = 'https://attendance.keepdev.top/api'\nvar BASR_URL = 'http://172.17.169.27:8080';\n/*export const myRequest = (options)=>{\r\n                                            \treturn new Promise((resolve,reject)=>{\r\n                                            \t\tuni.request({\r\n                                            \t\t\turl:BASR_URL + options.url,\r\n                                            \t\t\tmethod:options.method || 'GET',\r\n                                            \t\t\tdata:options.data || {},\r\n                                            \t\t\tsuccess: (res)=>{\r\n                                            \t\t\t\tconsole.log(res)\r\n                                            \t\t\t\tif(res.data.status !== 200) {\r\n                                            \t\t\t\t\treturn uni.showToast({\r\n                                            \t\t\t\t\t\ttitle:'请求失败'\r\n                                            \t\t\t\t\t})\r\n                                            \t\t\t\t}\r\n                                            \t\t\t\tresolve(res)\r\n                                            \t\t\t},\r\n                                            \t\t\tfali:(err)=>{\r\n                                            \t\t\t\t//if(err)\r\n                                            \t\t\t\tconsole.log(err)\r\n                                            \t\t\t\tuni.showToast({\r\n                                            \t\t\t\t\ttitle:'请求接口失败'\r\n                                            \t\t\t\t})\r\n                                            \t\t\t\treject(err)\r\n                                            \t\t\t}\r\n                                            \t\t})\r\n                                            \t})\r\n                                            } */\n\n// 封装请求方法\nvar myRequest = {\n  setToken: function setToken(token) {\n    __f__(\"log\", \"token:\" + token, \" at util/api.js:33\");\n    uni.setStorageSync('token', token);\n  },\n  request: function request(url, data, method, _success, fail) {\n    uni.request({\n      url: BASR_URL + url,\n      data: data,\n      method: method,\n      success: function success(res) {\n        __f__(\"log\", res, \" at util/api.js:42\");\n        _success(res);\n      },\n      fail: function fail(err) {\n        __f__(\"log\", method, url, \"fail\", err, \" at util/api.js:46\");\n        //fail(err); // 如果失败方法非空，执行失败方法\n      } });\n\n  },\n  requestWithToken: function requestWithToken(url, data1, method, _success2, fail) {\n    var token = uni.getStorageSync('token');\n    __f__(\"log\", \"requestWithToken：\" + token, \" at util/api.js:53\");\n    uni.request({\n      url: BASR_URL + url,\n      header: {\n        'content-type': 'application/json',\n        'Authorization': 'Bearer ' + token //默认携带token，未登录时，token为''\n      },\n      data: data1,\n      method: method,\n      success: function success(res) {\n        if (res.statusCode == 200) {\n\n          __f__(\"log\", 'inside api:success', res, \" at util/api.js:65\");\n          _success2(res.data);\n        } else {\n          __f__(\"log\", \"status code:\", res.statusCode, \" at util/api.js:68\");\n          uni.showToast({\n            icon: \"none\",\n            title: res.data.message });\n\n          if (fail) {\n            fail(res);\n          }\n        }\n        __f__(\"log\", \"success request\", \" at util/api.js:77\");\n        _success2(res);\n      },\n      fail: function fail(err) {\n        __f__(\"log\", method, url, \"fail\", \" at util/api.js:81\");\n        uni.showToast({\n          icon: \"none\",\n          title: err.data.message });\n\n      } });\n\n  },\n\n  getChildrenWithToken: function getChildrenWithToken(url, token, method, _success3, _fail) {\n    uni.request({\n      url: url,\n      header: {\n        'Authorization': token },\n\n      // data: data1,\n      method: method,\n      success: function success(res) {\n        // console.log(res);\n        if (res.statusCode == 200) {\n          _success3(res);\n        } else {\n          // 打印错误提示\n          uni.showToast({\n            icon: \"none\",\n            title: res.errMsg || \"请求失败\" });\n\n        }\n      },\n      fail: function fail(err) {\n        __f__(\"log\", method, url, \"fail\", \" at util/api.js:111\");\n        if (_fail) _fail(err); // 如果失败方法非空，执行失败方法\n      } });\n\n  },\n  get: function get(url, data, success, fail) {\n    this.request(url, data, 'GET', success, fail);\n  },\n  getWithToken: function getWithToken(url, token, data, success, fail) {\n    this.requestWithToken(url, token, data, 'GET', success, fail);\n  },\n  post: function post(url, data, success, fail) {\n    this.request(url, data, 'POST', success, fail);\n  },\n  put: function put(url, data, success, fail) {\n    this.request(url, data, 'PUT', success, fail);\n  },\n  del: function del(url, data, success, fail) {\n    this.request(url, data, 'DELETE', success, fail);\n  },\n\n\n  // 退出登录\n  logout: function logout() {\n    var url = urls.logout;\n    var data = {};\n    store.commit(\"logout\");\n  } };exports.myRequest = myRequest;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 10)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///14\n");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      // 0代表学生，1代表教师\n      role: 1,\n      modalName: null,\n      imageUrl: \"../../static/course-default.png\",\n      uid: '',\n      courseList: '' };\n\n  },\n  onLoad: function onLoad() {\n    this.uid = uni.getStorageSync('uid');\n    this.showCourse();\n  },\n  methods: {\n    showModal: function showModal(e) {\n      /*uni.showActionSheet({\n                                          itemList: ['一键签到', '限时签到', '手势签到'],\n                                          success: function (res) {\n                                              console.log('选中了第' + (res.tapIndex + 1) + '个按钮');\n                                      \t\tif(res.tapIndex === 0) {\n                                      \t\t\tconsole.log(\"A1\");\n                                      \t\t\tuni.navigateTo({\n                                      \t\t\t\turl: '../course/addCourse',\n                                      \t\t\t})\n                                      \t\t} else if(res.tapIndex === 1) {\n                                      \t\t\tconsole.log(\"B1\");\n                                      \t\t} else {\n                                      \t\t\tconsole.log(\"C1\");\n                                      \t\t}\n                                          },\n                                          fail: function (res) {\n                                              console.log(res.errMsg);\n                                          }\n                                      });*/\n      uni.showActionSheet({\n        itemList: ['创建班课', '通过班课号加入班课', '扫码加入班课'],\n        success: function success(res) {\n          __f__(\"log\", '选中了第' + (res.tapIndex + 1) + '个按钮', \" at pages/course/course.vue:94\");\n          if (res.tapIndex === 0) {\n            __f__(\"log\", \"A1\", \" at pages/course/course.vue:96\");\n            uni.navigateTo({\n              url: './addCourse' });\n\n          } else if (res.tapIndex === 1) {\n            __f__(\"log\", \"B1\", \" at pages/course/course.vue:101\");\n            uni.navigateTo({\n              url: './join/input-id' });\n\n          } else {\n            __f__(\"log\", \"C1\", \" at pages/course/course.vue:106\");\n            uni.scanCode({\n              scanType: ['qrCode', 'barCode'],\n              success: function success(res) {\n                var cno = res.result;\n                uni.navigateTo({\n                  url: './courseDatail/course-detail?id=' + cno });\n\n\n              } });\n\n          }\n        },\n        fail: function fail(res) {\n          __f__(\"log\", res.errMsg, \" at pages/course/course.vue:120\");\n        } });\n\n    },\n    showCourse: function showCourse() {var _this = this;\n      var url = '/courses/joined/' + this.uid;\n      __f__(\"log\", \"uid:\" + this.uid, \" at pages/course/course.vue:126\");\n      this.$myRequest.requestWithToken(url,\n      '', 'GET', function (res) {\n        if (res.statusCode == 200) {\n          __f__(\"log\", \"显示课程\", res.data.data.content, \" at pages/course/course.vue:130\");\n          _this.courseList = res.data.data.content;\n          /*cno = res.data.data.cno\n                                                    uni.navigateTo({\n                                                    \turl: './add-success?cno=' + cno\n                                                    })*/\n        } else {\n          __f__(\"log\", \"fails\", \" at pages/course/course.vue:137\");\n        }\n      });\n    },\n    detail: function detail(code) {\n      __f__(\"log\", \"查看详情\", code, \" at pages/course/course.vue:142\");\n      uni.navigateTo({\n        url: 'courseDatail/course-detail?id=' + code });\n\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 10)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///52\n");
...
var render = function() {
  ...
  return _c("view", [
    _c("view", { staticClass: _vm._$s(1, "sc", "center"), attrs: { _i: 1 } }, [
      _c("image", { attrs: { src: _vm._$s(2, "a-src", _vm.imageUrl), _i: 2 } }),
      _c("view", [_vm._v(_vm._$s(3, "t0-0", _vm._s(_vm.courseID)))]),
      _c("view", [_vm._v(_vm._$s(4, "t0-0", _vm._s(_vm.course.name)))])
    ]),
    _c(
      "view",
      {
        staticClass: _vm._$s(5, "sc", "padding flex flex-direction"),
        attrs: { _i: 5 }
      },
      [
        _c("button", {
          ...
          on: {
            click: function($event) {
              return _vm.classJoin()
            }
          }
        })
      ]
    ),
    _c("view", [_c("view-tabbar", { attrs: { tabIndex: "5", _i: 8 } })], 1)
  ])
}
var recyclableRender = false
var staticRenderFns = []
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _tabCourse = _interopRequireDefault(__webpack_require__(/*! @/components/tab-course.vue */ 63));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { 'view-tabbar': _tabCourse.default }, data: function data() {return { imageUrl: \"../../../static/course-default.png\", courseID: '', course: '' };}, onLoad: function onLoad(option) {this.courseID = option.id;__f__(\"log\", this.courseID, \" at pages/course/courseDatail/course-detail.vue:35\");this.searchCourse();}, methods: { searchCourse: function searchCourse() {var _this = this;var url = '/courses/code/' + this.courseID;\n      __f__(\"log\", \"uid:\" + this.uid, \" at pages/course/courseDatail/course-detail.vue:41\");\n      this.$myRequest.requestWithToken(url,\n      null, 'GET', function (res) {\n        if (res.statusCode == 200) {\n          __f__(\"log\", \"显示课程详情\", res.data.data, \" at pages/course/courseDatail/course-detail.vue:45\");\n          _this.course = res.data.data;\n\n        } else {\n          __f__(\"log\", \"fails\", \" at pages/course/courseDatail/course-detail.vue:49\");\n        }\n      });\n    },\n    classJoin: function classJoin() {\n      var uid = uni.getStorageSync('uid');\n      var url = '/courses/student/' + uid + '/' + this.courseID;\n      this.$myRequest.requestWithToken(url,\n      null, 'POST', function (res) {\n        if (res.statusCode == 200) {\n          __f__(\"log\", \"显示课程详情\", res.data, \" at pages/course/courseDatail/course-detail.vue:59\");\n          uni.showToast({\n            title: \"加入班课成功\" });\n\n\n        } else {\n          __f__(\"log\", \"fails\", \" at pages/course/courseDatail/course-detail.vue:65\");\n        }\n      });\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 10)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///72\n");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      courseID: \"\" };\n\n  },\n  onLoad: function onLoad() {\n\n  },\n  methods: {\n    searchCourse: function searchCourse() {var _this = this;\n      __f__(\"log\", \"asd\", this.courseID, \" at pages/course/join/input-id.vue:27\");\n      var url = '/courses/code/' + this.courseID;\n      __f__(\"log\", \"uid:\" + this.uid, \" at pages/course/join/input-id.vue:29\");\n      this.$myRequest.requestWithToken(url,\n      null, 'GET', function (res) {\n        if (res.statusCode == 200) {\n          __f__(\"log\", \"显示课程详情\", res.data.data, \" at pages/course/join/input-id.vue:33\");\n          uni.navigateTo({\n            url: '../courseDatail/course-detail?id=' + _this.courseID });\n\n        } else {\n          __f__(\"log\", \"fails\", \" at pages/course/join/input-id.vue:38\");\n        }\n      });\n\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 10)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///117\n");
